...
const SearchComponent = () => {
  ...
  return (
    <div className="max-w-[700px] mx-auto mt-[25px] px-4">
      <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-2 md:gap-0">
        ...
        <div className="relative w-full md:w-auto">
          ...
          <input
            type="text"
            id="voice-search"
            className="bg-yellow-50 border border-yellow-300 text-gray-900 text-sm block w-full md:w-[400px] pl-10 p-2.5 dark:bg-yellow-500 dark:border-yellow-500 dark:placeholder-gray-400 dark:text-white"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className={`w-full md:w-auto inline-flex justify-center items-center py-4 px-5 md:ml-2 text-sm font-medium text-white bg-yellow-500 rounded-full shadow-lg hover:bg-green-900 focus:ring-4 focus:outline-none dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800 transition-all duration-200 ${
