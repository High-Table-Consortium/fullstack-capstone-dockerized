...
const ReviewPage = () => {
  ...
  return (
    <div className="min-h-screen h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-6">
        <h1 className="text-black text-2xl font-bold text-center mb-6">Write a Review</h1>
        <div className="flex flex-col md:flex-row">
          {/* Left side - Destination info */}
          <div className="md:w-1/3 pr-6 mb-6 md:mb-0">
            <h2 className="text-black text-xl font-semibold mb-2">(Destination name)</h2>
          ...
          <div className="md:w-2/3">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-green-900 text-white py-2 px-4 rounded-md">
                Submit Review
              </button>
            </form>
          </div>
