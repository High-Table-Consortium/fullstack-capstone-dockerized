        ...
        <section className="py-16 bg-gray-100">
          <div className="container mx-auto px-4">
            ...
            <div className="flex space-x-6 overflow-x-auto pb-6">
              {[{ name: "Cape Town", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_WMMhbPwXDzmtzcKUxE3m4wLxxx3KhW7EKA&s" }, { name: "Johannesburg", image: "https://images.squarespace-cdn.com/content/v1/57b9b98a29687f1ef5c622df/1478273230409-FGHP1T1WJR1OAMAHG6AB/00.jpg?format=1500w" }, { name: "Durban", image: "https://silversea-discover.imgix.net/2024/01/durbanheroistockphoto.jpg?auto=compress%2Cformat&ixlib=php-3.3.1" }, { name: "Port Elizabeth", image: "https://thumbs.dreamstime.com/b/aerial-port-elizabeth-south-africa-view-44811213.jpg" }, { name: "Pretoria", image: "" }].map((city, index) => (
                <motion.div
                  key={index}
